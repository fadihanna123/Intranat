          ...
          { // Om man är inloggad.
            ...
            { // Om användaren har administratörsbehörigheter.
              ...
              echo '
                ...
                <div class="container-fluid">
                    <div id="addnewsmain">';
              $addtitle = strip_tags(htmlentities(isset($_POST["addtitle"]) ? $_POST["addtitle"] : ""));
              $addcat = strip_tags(htmlentities(isset($_POST["addcat"]) ? $_POST["addcat"] : ""));
              $addcontent = isset($_POST["addcontent"]) ? $_POST["addcontent"] : "";  
              $filename = isset($_FILES['addimg']['name']) ? $_FILES['addimg']['name'] : "";
              $filetype = isset($_FILES['addimg']['type']) ? $_FILES['addimg']['type'] : "";
              $tmpname = isset($_FILES['addimg']['tmp_name']) ? $_FILES['addimg']['tmp_name'] : "";
            if (isset($_POST['addbtn']))
            { // Om användare klickade på Lägg till knappen.
              if (empty($addtitle) || empty($addcat) || empty($addcontent) || empty($filename)) 
              ...
              { // Om det finns samtliga fält.
                    ...
                    { // Om användare bifogade bildfil och bildtyper var jpg, png, jpeg och gif.
                      ...
                      $dashboard->addNews($addtitle, $addcat, $addcontent, $bild, $_SESSION['loginuname']);
