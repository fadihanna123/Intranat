  ...
  $getid = $_GET['id']; 
    ...
    { // Om man är inloggad.
      ...
      echo '<img src="Images/Ikoner/register.png" class="img-fluid specheadicon2" alt="Redigera nyhet ikon" />
              ...
              <div class="container-fluid">
                <div id="editnewsmain">';
          $edittitle =  strip_tags(htmlentities(isset($_POST["edittitle"]) ? $_POST["edittitle"] : ""));
          $editcat = strip_tags(htmlentities(isset($_POST["editcat"]) ? $_POST["editcat"] : ""));
          $editcontent = isset($_POST["editcontent"]) ? $_POST["editcontent"] : "";
          $filename = isset($_FILES['editimg']['name']) ? $_FILES['editimg']['name'] : "";
          $filetype = isset($_FILES['editimg']['type']) ? $_FILES['editimg']['type'] : "";
          $tmpname = isset($_FILES['editimg']['tmp_name']) ? $_FILES['editimg']['tmp_name'] : "";
                ...
                { // Om användare klickade på Uppdatera knappen.
                    ...
                    { // Om användare bifogade bildfil och bildtyper var jpg, png, jpeg och gif.
                      ...
                      $dashboard->UpdateNews($getid, $edittitle, $editcat, $editcontent, isset($bild) ? $bild : "", $_SESSION['loginuname']);
