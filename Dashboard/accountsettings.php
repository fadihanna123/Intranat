...
<?php require("Includes/nav.php"); ?>
  ...
  <div class="container-fluid">
    ...
    <?php
              $editusername = strip_tags(htmlentities(isset($_POST['editusername']) ? $_POST['editusername'] : ""));  
              $editfullname = strip_tags(htmlentities(isset($_POST['editfullname']) ? $_POST['editfullname'] : ""));  
              $editaddressstreet = strip_tags(htmlentities(isset($_POST['editaddressstreet']) ? $_POST['editaddressstreet'] : "")); 
              $editaddressbox = strip_tags(htmlentities(isset($_POST['editaddressbox']) ? $_POST['editaddressbox'] : "")); 
              $editaddresscity = strip_tags(htmlentities(isset($_POST["editaddresscity"]) ? $_POST["editaddresscity"] : ""));
              $editmobnr = strip_tags(htmlentities(isset($_POST["editmobnr"]) ? $_POST["editmobnr"] : ""));
              $edittfnr = strip_tags(htmlentities(isset($_POST["edittfnr"]) ? $_POST["edittfnr"] : ""));
              $editavatar = isset($_FILES["editavatar"]['name']) ? $_FILES["editavatar"]['name'] : "";
              $filetype = isset($_FILES["editavatar"]['type']) ? $_FILES["editavatar"]['type'] : ""; 
              $tmpname = isset($_FILES["editavatar"]['tmp_name']) ? $_FILES["editavatar"]['tmp_name'] : "";
              $editepost = strip_tags(htmlentities(isset($_POST["editepost"]) ? $_POST["editepost"] : ""));
              $editconfirmepost = strip_tags(htmlentities(isset($_POST["editconfirmepost"]) ? $_POST["editconfirmepost"] : ""));
              $editpsw = strip_tags(htmlentities(isset($_POST["editpsw"]) ? $_POST["editpsw"] : ""));
              $editconfirmpsw = strip_tags(htmlentities(isset($_POST["editconfirmpsw"]) ? $_POST["editconfirmpsw"] : ""));
              $editadminmange = strip_tags(htmlentities(isset($_POST["editadminmange"]) ? $_POST["editadminmange"] : ""));
            ...
            { // Om man är inloggad.
              ...
              { // Om användare klickade på Uppdatera knappen.
                ...
                if (isset($editavatar) && $filetype = "image/jpg" && $filetype = "image/png" && $filetype = "image/jpeg"
                && $filetype = "image/gif")
                { // Om användare bifogade bildfil och bildtyper var jpg, png, jpeg och gif.

                  
                    if (move_uploaded_file($tmpname, "./Images/Users/$editavatar"))
                ...
                $dashboard->UpdateAccountSettings($editusername, $editfullname , $editaddressstreet, $editaddressbox, $editaddresscity, $editmobnr, $edittfnr, isset($bild) ? $bild : "");
