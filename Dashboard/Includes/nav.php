            ...
            <ul class="navbar-nav dashboardul flex-column">
              <li class="nav-item">
                <a class="firstlink nav-link font-weight-bold navlinks" href="index.php">
                  <img src="Images/Ikoner/house.png" loading="lazy" class="icon img-fluid" alt="Hemsikonen" />
                  Hem
                </a>
              </li>
                  <li class="nav-item">
                    <a class="nav-link font-weight-bold navlinks" href="news.php">
                      <img src="Images/Ikoner/news.png" loading="lazy" class="icon img-fluid" alt="Nyhetersikon" />
                          Nyheter
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                        <a class="nav-link font-weight-bold navlinks" href="filarkiv.php">
                          <img src="Images/Ikoner/arkiv.png" loading="lazy" class="icon img-fluid" alt="Filarkivsikon" />
                          Filarkiv
                        </a>
                  </li> 
                  ...
                  <li class="nav-item">
                        <a class="nav-link font-weight-bold navlinks" href="staff.php">
                          <img src="Images/Ikoner/staff.png" loading="lazy" class="icon img-fluid" alt="Personalsikon" />
                            Personal
                        </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a class="nav-link font-weight-bold navlinks" href="report.php">
                      <img src="Images/Ikoner/register.png" loading="lazy" class="icon img-fluid" alt="Anmälan" />
                        Anmälan
                      </a>
                    </li> 
                    ...
                    <li class="nav-item">
                      <a class="nav-link faqlink font-weight-bold navlinks" href="FAQ.php">
                        <img src="Images/Ikoner/help.png" loading="lazy" class="icon img-fluid" alt="Hjälpikonen" />
                        FAQ
                      </a>
                    </li> 
                    ...
                    <li class="nav-item">
                      ...
                      <img src="Images/Ikoner/settings-1.png" loading="lazy" class="icon img-fluid" alt="Kontoinställningarsikonen" />
                            Mitt konto
                      </a>
                    </li>
                <li class="nav-item" style="z-index: 1; position: relative;">
                  <a class="nav-link font-weight-bold navlinks" href="admin.php">
                    <img src="Images/Ikoner/admin.png" loading="lazy" class="icon img-fluid" alt="Administratörsikon" />
                      Adminpanel
                  </a>
                </li> 
                </ul>
