...
<?php require("Includes/nav.php"); ?>
  ...
  <div class="container-fluid">
    ...
    <?php
              ...
              $editimglogo = isset($_FILES['editimglogo']['name']) ? $_FILES['editimglogo']['name'] : "";  
              $filetype = isset($_FILES['editimglogo']['type']) ? $_FILES['editimglogo']['type'] : "";  
              $tmpname = isset($_FILES['editimglogo']['tmp_name']) ? $_FILES['editimglogo']['tmp_name'] : "";  
              ...
              $editorgnr = strip_tags(htmlentities(isset($_POST["editorgnr"]) ? $_POST["editorgnr"] : ""));
              $editvisitaddress = strip_tags(htmlentities(isset($_POST["editvisitaddress"]) ? $_POST["editvisitaddress"] : ""));
              $editfirstcolor = strip_tags(htmlentities(isset($_POST["editfirstcolor"]) ? $_POST["editfirstcolor"] : ""));
              $editsecondcolor = strip_tags(htmlentities(isset($_POST["editsecondcolor"]) ? $_POST["editsecondcolor"] : ""));
              $editcompanyname = strip_tags(htmlentities(isset($_POST["editcompanyname"]) ? $_POST["editcompanyname"] : ""));
              $editinvoiceinfo = html_entity_decode(isset($_POST["editinvoiceinfo"]) ? $_POST["editinvoiceinfo"] : "");
                ...
                { // Om användare klickade på Godkänna knappen.
                  ...
                  $dashboard->AcceptStaff($getid);
                      ...
                      { // Om användare klickade på Uppdatera knappen.
                        ...
                        if (isset($editimglogo) && $filetype = "image/jpg" && $filetype = "image/png" && $filetype = "image/jpeg"
                        && $filetype = "image/gif")
                        { // Om användare bifogade bildfil och bildtyper var jpg, png, jpeg och gif.

                          
                            if (move_uploaded_file($tmpname, "Images/Admin/$editimglogo"))
                        ...
                        $dashboard->UpdateAdminSettings($editcompanyname, isset($bild) ? $bild : "", $editorgnr, $editinvoiceinfo, $editaddressstreet, $editaddressbox, $editaddresscity, $editvisitaddress, $editfirstcolor, $editsecondcolor);
                      ...
                      { // Om användare klickade på Lägg till knappen.
                        ...
                        $addcatname = strip_tags(htmlentities(isset($_POST['addcatname']) ? $_POST['addcatname'] : ""));
                        $addcatdb = strip_tags(htmlentities(isset($_POST['addcatdb']) ? $_POST['addcatdb'] : ""));
