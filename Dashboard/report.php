...
<?php require("Includes/nav.php"); ?>
  ...
  <div class="container-fluid">
    <div class="mymain">
    <?php
          $sickreason = html_entity_decode(isset($_POST["sickreason"]) ? $_POST["sickreason"] : "");
          $sickfrom = strip_tags(htmlentities(isset($_POST["sickfrom"]) ? $_POST["sickfrom"] : ""));
          $sickto = strip_tags(htmlentities(isset($_POST["sickto"]) ? $_POST["sickto"] : ""));  
          $leavereason = html_entity_decode(isset($_POST["leavereason"]) ? $_POST["leavereason"] : "");
          $leavefrom = strip_tags(htmlentities(isset($_POST["leavefrom"]) ? $_POST["leavefrom"] : ""));
          $leaveto = strip_tags(htmlentities(isset($_POST["leaveto"]) ? $_POST["leaveto"] : ""));
            ...
            { // Om det finns värde i samtliga fält.
              ...
              { // Om användare klickade på Anmäla knappen.
                ...
                { // Om det finns värde i samtliga fält.
                    ...
                    $dashboard->SendLeaveRequest($leavereason, $leavefrom, $leaveto);                
