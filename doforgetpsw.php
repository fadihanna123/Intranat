...
<div class="container text-center">
  ...
  <?php
    ...
    { // Om det finns återställningsnyckel i adressfältet.
      $forgetepswepost = strip_tags(htmlentities(isset($_POST['forgetepswepost']) ? $_POST['forgetepswepost'] : ""));
      ...
      { // Om man klickade på Återställa lösenordet. 
          if (empty($forgetepswepost) || empty($forgetpsw) || empty($confirmpsw))
              ...
              { // Om man fyllde in en korrekt e-postadress.
                  ...
                  { // Om lösenordsfält har 6 tecken eller längre.
                      ...
                      { // Om både lösenordsfält matchades.
                          $functions->changepsw($key, $uid, $forgetepswepost, $forgetpsw);
      ...
      } // Slut om man klickade på Återställa lösenordet. 
