    ...
    <form action="<?= $_SERVER['PHP_SELF'] ?>" class="col-12 needs-validation" novalidate id="registerform" method="post" enctype="multipart/form-data">
          ...
          <div class="row h-100 justify-content-center align-items-center">
              <div class="form-group">
                <label for="registerfname">Förnamn:*</label>
          ...
          <div class="row h-100 justify-content-center align-items-center">
              <div class="form-group">
                <label for="registerlname">Efternamn:*</label>
          ...
          <div class="row h-100 justify-content-center align-items-center">
              <div class="form-group">
                <label for="registerepost">E-postadress:*</label>
            ...
            <div class="row h-100 justify-content-center align-items-center">
              <div class="form-group">
                <label for="registermobnr">Mobilnummer:*</label>
            ...
            <div class="row h-100 justify-content-center align-items-center">
              <div class="form-group">
                <label for="registertfnr">Telefonnummer:*</label>
            ...
            <div class="row h-100 justify-content-center align-items-center">
              <div class="form-group">
                <label for="registerpsw">Lösenord:*</label>
                <input type="password" class="form-control" name="registerpsw" id="registerpsw" required /><br />
            </div>
            </div>

            <div class="row h-100 justify-content-center align-items-center">
              <div class="form-group">
                  <label for="registerwork">Yrkestitel:*</label>
                  <input type="text" class="form-control" name="registerwork" id="registerwork" required /><br />
            </div>
            </div>
          <div class="row h-100 justify-content-center align-items-center">
            <div class="form-group">
              <label id="bornlabel">Födelsedatum:*</label>
              <select class="form-control mb-1" name="registerbornday" id="registerbornday" required>
              ...
              <select name="registerbornmonth" class="form-control mb-1" id="registerbornmonth" required>
              ...
              <select name="registerbornyear" class="form-control mb-1" id="registerbornyear" required>
        ...
        <div id="registersexlabel">Kön:*</div>
